    ...
    const response = await fetch("https://api.openai.com/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `Tu es un assistant nutritionnel. Analyse cette phrase et identifie les aliments mentionnés avec leurs quantités estimées en grammes. Si aucune quantité n'est précisée, estime une portion standard. Réponds UNIQUEMENT en JSON valide, sans markdown ni backticks:
{"foods": [{"name": "nom de l'aliment en français", "grams": nombre}]}
