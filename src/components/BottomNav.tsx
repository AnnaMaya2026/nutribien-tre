...
import { LayoutDashboard, BookOpen, ChefHat, Bot, Sun, Moon } from "lucide-react";
import { useState, useEffect } from "react";

const tabs = [
  { path: "/", label: "Accueil", icon: LayoutDashboard },
  { path: "/journal", label: "Journal", icon: BookOpen },
  { path: "/repas", label: "Repas", icon: ChefHat },
    ...
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-tab-bar tab-bar-shadow border-t border-border">
      <div className="flex items-center justify-around px-2 py-2 max-w-lg mx-auto">
        ...
        <button
          ...
          className="flex flex-col items-center gap-0.5 px-3 py-1.5 text-tab-inactive"
        >
