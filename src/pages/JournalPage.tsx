...
export default function JournalPage() {
    ...
    updateLog.mutate(
      {
        ...
        calcium: scaleOrNull((log as any).calcium, r),
        vitamin_d: scaleOrNull((log as any).vitamin_d, r, 1),
        magnesium: scaleOrNull((log as any).magnesium, r),
        iron: scaleOrNull((log as any).iron, r, 1),
        omega3: scaleOrNull((log as any).omega3, r, 1),
        phytoestrogens: scaleOrNull((log as any).phytoestrogens, r, 1),
        vitamin_b12: scaleOrNull((log as any).vitamin_b12, r, 1),
        potassium: scaleOrNull((log as any).potassium, r),
        zinc: scaleOrNull((log as any).zinc, r, 1),
        vitamin_k: scaleOrNull((log as any).vitamin_k, r, 1),
        vitamin_b6: scaleOrNull((log as any).vitamin_b6, r, 2),
        vitamin_b9: scaleOrNull((log as any).vitamin_b9, r),
        vitamin_e: scaleOrNull((log as any).vitamin_e, r, 1),
      },
      {
        onSuccess: () => {
  ...
  const handleSaveFavorite = () => {
    ...
    const items = saveFavModal.items.map((l: any) => ({
      ...
      fats: l.fats || 0,
      fibres: l.fibres || 0,
      calcium: (l as any).calcium ?? null,
      vitamin_d: (l as any).vitamin_d ?? null,
      magnesium: (l as any).magnesium ?? null,
      iron: (l as any).iron ?? null,
      omega3: (l as any).omega3 ?? null,
      phytoestrogens: (l as any).phytoestrogens ?? null,
      vitamin_b12: (l as any).vitamin_b12 ?? null,
      potassium: (l as any).potassium ?? null,
      zinc: (l as any).zinc ?? null,
      vitamin_k: (l as any).vitamin_k ?? null,
      vitamin_b6: (l as any).vitamin_b6 ?? null,
      vitamin_b9: (l as any).vitamin_b9 ?? null,
      vitamin_e: (l as any).vitamin_e ?? null,
    }));
    saveFavorite.mutate(
  ...
  const handleAddFavoriteToJournal = (destMeal: string) => {
    ...
    fav.items.forEach((item) => {
      addLog.mutate({
        ...
        potassium: (item as any).potassium ?? null,
        zinc: (item as any).zinc ?? null,
        vitamin_k: (item as any).vitamin_k ?? null,
        vitamin_b6: (item as any).vitamin_b6 ?? null,
                        ...
                        <div className="px-3 pb-3">
                          <NutrientDetailSections
                            scaled={{
                              ...
                              fats: log.fats || 0,
                              fibres: log.fibres || 0,
                              calcium: (log as any).calcium ?? null,
                              vitamin_d: (log as any).vitamin_d ?? null,
                              magnesium: (log as any).magnesium ?? null,
                              iron: (log as any).iron ?? null,
                              omega3: (log as any).omega3 ?? null,
                              vitamin_b12: (log as any).vitamin_b12 ?? null,
                              phytoestrogens: (log as any).phytoestrogens ?? null,
                              potassium: (log as any).potassium ?? null,
                              zinc: (log as any).zinc ?? null,
                              vitamin_k: (log as any).vitamin_k ?? null,
                              vitamin_b6: (log as any).vitamin_b6 ?? null,
                              vitamin_b9: (log as any).vitamin_b9 ?? null,
                              vitamin_e: (log as any).vitamin_e ?? null,
                            }}
                          />
